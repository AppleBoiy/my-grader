...
class TestIsAnagram(unittest.TestCase):
    ...
    def test_non_anagrams(self):
        ...
        self.assertFalse(is_anagram("tests", "text"))
    ...
    def test_random_anagrams(self):
        ...
        for i in range(1_000_000):  # Generate and tests 1000 random anagrams
            ...
            if i % 100000 == 0:
                print(f"{i} out of {num_test_cases} tests cases tested.")
